...
then
	...
	echo
	cmd=(javac PlayerGenerator.java)
	cmd=(javac CacheTest.java)
	cmd=(java PlayerGenerator 50 3.0 0 123)
	cmd=(java PlayerGenerator 1000 15.0 0 123)
	cmd=(java PlayerGenerator 100000 2500.0 0 123)
